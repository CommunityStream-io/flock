...
export const routes: Routes = [
  ...
  { path: 'landing', outlet: 'step', component: LandingPageComponent,                                            title: 'Welcome',                data: { description: 'Overview of the migration and getting started',       prev: null,      next: 'upload'   } },
  { path: '**', redirectTo: '' }
];